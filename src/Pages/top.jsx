    ...
    >
      ...
      >
        <div className="text-white text-center text-9xl flex flex-col justify-center items-center gap-4">
          ...
          <div>
            <HomeInput
              className="md:w-[35rem] w-[sm:25rem]"
              height="2rem"
          ...
          <div className="gap-4 text-sm gap-3  bg-black text-start flex flex-col justify-center items-ce w-full">
            <div className=" max-w-[60vw]">
              <div className="w-[full]">
                ...
                Near the end of 2016, after checking popular free anime
                streaming sites, we found most sites lacked a good user
                interface (UI) and did not provide a good user experience (UX).
                So, our product development team created 9anime to provide anime
                fans with a better one.
              </div>
              <div className="w-full">
                Because of DMCA issues and multiple ISPs blocking our domain, by
                the end of 2023, we decided to rebrand 9anime as AniWave. This
                new wave aims to bring even better things to anime fans.
              </div>
              <div className="w-full">
              ...
              <div className="w-full">
                ...
                - Content library: We were only a few hundred of old animes
                behind kisanime when it was around. We have been adding new and
                old animes every hour to our library. You can find almost
                everything here. After the closing of kissanime, we become the
                largest anime library on the web.
                <div>
                  - Streaming experience: We have top of the line streaming
                  servers. You can simply choose one that is fast for you.
                </div>
                <div>
                  - Quality/Resolution: All our video files are encoded in
                  highest possible resolution. We also have quality setting
                  function that allows every user to enjoy streaming regardless
                  of their internet speed.
                </div>
                <div>
                  - Updates: Our content is updated hourly, most of the works
                  done automatically so you will get update as fast as possible.
                </div>
                <div>
                  - User interface: We focus on the simple and easy to use, so
                  you will feel the life is easier here. We also have almost
                  every feature that other anime streaming sites have, but not
                  the opposite.
                </div>
                ...
                <div>
                  So, if you want a good and safe place to watch anime online
                  for free, give Aniwave a try, and if you like what we
                  provided, please help us by sharing 9anime to your friends and
                  do not forget to bookmark our site.
                </div>
                Thanks!
              </div>
            </div>
