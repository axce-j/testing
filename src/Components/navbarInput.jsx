          ...
          <div className="flex flex-col bg-[rgba(32,32,35,1)] absolute top-0 left-0  rounded-lg w-full max-w-full ">
                ...
                <div className=" w-[10rem] flex justify-end ">
                  {searchOption !== null ? (
                    <div className="flex flex-row  text-xs items-center underline gap-2 font-medium ">
                      {" "}
                      <div className="cursor-pointer" onClick={()=>{manageInputSearchOption("empty");
                   }}>Clear</div>
                    </div>
                  ) : (
            ...
            <div
              ...
              className={` flex flex-col  max-h-fit  overflow-hidden ${
                ((searchOption !== null) && (searchOption !== "")) ? `max-h-fit` : `hidden`
            ...
            >
              ...
              <div className={`w-full max-h-[450px] flex flex-col  px-1 bg-gray-900 overflow-y-scroll gap-1 ${searchOption == null ?`hidden`:``}`}>
              {((searchOption == null) || (searchOption == "")) ? "":animeSearchDataContent?.map((items, index) => {
                ...
                return (
                  <div key={mal_id} className=" grid grid-cols-[1fr,4fr] gap-2 items-center px-3 py-1 bg-gray-800">
                    <div className=" w-full"> <div className="w-24 h-[80px] "  style={{
                   ...
                   <div className="font-bold break-words text-sm">{title}</div> 
