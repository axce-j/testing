...
const BrowsePagePaginationComponent=({ paginationNumbersArray,manageNextButton,managePreviousButton,setToPaginationEnd , managePaginationOnClick,paginationNumbersCurrentPage})=>{
...
export default BrowsePagePaginationComponent;