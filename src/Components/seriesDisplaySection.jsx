      ...
      <section className=" flex mt-20 box-border   px-4   flex-col gap-[10rem] w-full">
        ...
        >
          <div className="flex flex-col gap-3">
            <div className="w-full h-48 bg-teal-700 rounded-xl flex justify-between px-12 items-center"> <div className="w-24 h-24 rounded-full bg-black flex items-center justify-center"><img src="logo3.png" alt="logo" className="w-[32px] h-[32px]" /></div>
            ...
            <div className="w-24 h-24 rounded-full bg-black  flex items-center justify-center"><img src="logo3.png" alt="logo" className="w-[32] h-[32]" /></div>
            </div>
